...
DiscoveryCANServerLinux<EndPoint>::DiscoveryCANServerLinux(
...
template<typename EndPoint>
bool DiscoveryCANServerLinux<EndPoint>::init(
...
template<typename EndPoint>
bool DiscoveryCANServerLinux<EndPoint>::close()
{
    if (-1 == poll_fd_.fd)
    {
        return true;
...
template class DiscoveryCANServerLinux<CANEndPoint>;
